...
:!table-caption:
:page-pagination:
:page-help-url: https://nowhere.com
...
<2> Wrap each streaming file in a buffer so the files can be processed by terser.
Terser can only work with buffers, not streams.
